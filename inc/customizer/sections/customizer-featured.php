...
function gridbox_customize_register_featured_settings( $wp_customize ) {
	...
	$wp_customize->add_setting(
		'gridbox_theme_options[featured_activate]',
		array(
			'default'           => '',
			'type'              => 'option',
			'transport'         => 'refresh',
	...
	$wp_customize->add_setting(
		'gridbox_theme_options[featured_magazine]',
		array(
			'default'           => false,
			'type'              => 'option',
			'transport'         => 'refresh',
	...
	$wp_customize->add_setting(
		'gridbox_theme_options[featured_blog]',
		array(
			'default'           => false,
			'type'              => 'option',
			'transport'         => 'refresh',
	...
	$wp_customize->add_setting(
		'gridbox_theme_options[featured_category]',
		array(
			'default'           => 0,
			'type'              => 'option',
			'transport'         => 'refresh',
	...
	$wp_customize->add_control(
		new Gridbox_Customize_Category_Dropdown_Control(
			$wp_customize,
			'gridbox_theme_options[featured_category]',
			array(
