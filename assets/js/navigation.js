/* global gridboxScreenReaderText */
/**
 * Theme Navigation
 *
 * @package Gridbox
...
(function( $ ) {
	...
	function initNavigation( containerClass, naviClass ) {
		...
		(function() {
			...
			menuToggle.on( 'click.gridbox_', function() {
		...
		(function() {
			...
			var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false } )
				.append( gridboxScreenReaderText.icon )
				.append( $( '<span />', { 'class': 'screen-reader-text', text: gridboxScreenReaderText.expand } ) );
			...
			navigation.find( '.current-menu-ancestor > button' )
				...
				.text( gridboxScreenReaderText.collapse );
			...
			navigation.find( '.dropdown-toggle' ).click( function( e ) {
				...
				screenReaderSpan.text( screenReaderSpan.text() === gridboxScreenReaderText.expand ? gridboxScreenReaderText.collapse : gridboxScreenReaderText.expand );
			} );
		})();
		...
		(function() {
			...
			function toggleFocusClassTouchScreen() {
				if ( 'none' === $( '.menu-toggle' ).css( 'display' ) ) {
					...
					$( document.body ).on( 'touchstart.gridbox_', function( e ) {
					...
					menuList.find( '.menu-item-has-children > a, .page_item_has_children > a' )
						.on( 'touchstart.gridbox_', function( e ) {
					...
					menuList.find( '.menu-item-has-children > a, .page_item_has_children > a' ).unbind( 'touchstart.gridbox_' );
				}
			}

			if ( 'ontouchstart' in window ) {
				$( window ).on( 'resize.gridbox_', toggleFocusClassTouchScreen );
				toggleFocusClassTouchScreen();
			}

			menuList.find( 'a' ).on( 'focus.gridbox_ blur.gridbox_', function() {
