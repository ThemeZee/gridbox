...
/**
 * Gridbox only works in WordPress 4.2 or later.
 */
...
function gridbox_widgets_init() {
	...
	register_sidebar( array(
		...
		'id' => 'sidebar',
		'description' => esc_html__( 'Appears on posts and pages except full width template.', 'gridbox' ),
...
function gridbox_scripts() {
	...
	wp_enqueue_style( 'gridbox-stylesheet', get_stylesheet_uri() );
	
	// Register Genericons
	wp_enqueue_style( 'gridbox-genericons', get_template_directory_uri() . '/css/genericons/genericons.css' );
	
	// Register and Enqueue HTML5shiv to support HTML5 elements in older IE versions
	wp_enqueue_script( 'gridbox-html5shiv', get_template_directory_uri() . '/js/html5shiv.min.js', array(), '3.7.2', false );
	$wp_scripts->add_data( 'gridbox-html5shiv', 'conditional', 'lt IE 9' );

	// Register and enqueue navigation.js
	wp_enqueue_script( 'gridbox-jquery-navigation', get_template_directory_uri() .'/js/navigation.js', array('jquery') );
